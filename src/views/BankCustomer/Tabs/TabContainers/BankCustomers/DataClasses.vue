<template>
  ...
  >
    ...
    <template v-slot:items-selected="{ scope }"
      >You picked {{ scope.count }} rows.</template
    >
  </cv-data-table>
</template>
...
import { Save16, TrashCan16, Download16 } from '@carbon/icons-vue';

export default {
  name: 'DataClasses',
  // components: { Growth },
  components: { Save16, TrashCan16, Download16 },
  data: function() {
    return {
      rowSize: '',
      autoWidth: false,
      ...
      sampleOverflowMenu: ['Edit', 'New', 'Remove'],
      rowSelects: []
    };
  },
  created() {},
